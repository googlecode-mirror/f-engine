<h1>Email Class</h1>
<p>
    F-engine's robust Email Class supports the following features:
</p>
<ul>
    <li>
...
<p>
    Preferences are set by passing an array of preference values to the email 
    <dfn>
        initialize
    </dfn>
    function.  Here is an example of how you might set some preferences:
</p>
<code>
...
<p>
    ...
    If you do not set your own message F-engine will extract the message from your HTML email and strip the tags.
</p>
...
<p>
    Enables you to send an attachment. Put the file path/name in the first parameter. Note: Use a file path, not a URL.
    For multiple attachments use the function multiple times. For example:
</p>
<code>
...
<p>
    ...
    get wrapped too, causing it to become un-clickable by the person receiving it.  F-engine lets you manually override
...
<code>
    ...
    <var>
        {unwrap}
    </var>http://example.com/a_long_link_that_should_not_be_wrapped.html
    <var>
        {/unwrap}
    </var>
    <br/>
...
<p>
    Place the item you do not want word-wrapped between: 
    <var>
        {unwrap}
    </var>
    <var>
