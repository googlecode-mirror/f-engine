...
<p>
    These variables are not actual PHP variables, but rather plain text representations that allow you to eliminate
    PHP from your templates (view files).
</p>
<p class="important">
    <strong>Note:</strong>
    F-engine does <strong>not</strong>
    require you to use this class
...
<p>
    ...
    The Template Parser Class is <strong>not</strong>
    a
    full-blown template parsing solution. We've kept it very lean on purpose in order to maintain maximum performance.
</p>
<h2>Initializing the Class</h2>
<p>
    Like most other classes in F-engine, the Parser class is initialized in your controller using the 
    <dfn>
        $this->load->library
    </dfn>
    function:
...
<p>
    ...
    pass TRUE (boolean) to the third parameter:
</p>
<code>
...
<p>
    The above example code allows simple variables to be replaced.  What if you would like an entire block of variables to be
    repeated, with each iteration containing new values?  Consider the template example we showed at the top of the page:
</p>
<code>
    &lt;html&gt;
    <br/>
...
<p>
    In the above code you'll notice a pair of variables: 
    <kbd>
        {blog_entries}
    </kbd>
    data... 
...
<p>
    If your "pair" data is coming from a database result, which is already a multi-dimensional array, you can simply
