...
<p class="important">
    <strong>Note:</strong>
    The Session class does <strong>not</strong>
    utilize native PHP sessions. It
...
<p>
    To initialize the Session class manually in your controller constructor, use the 
    <dfn>
        $this->load->library
    </dfn>
    function:
...
<p>
    ...
    If sessions data does <strong>not</strong>
    exist (or if it has expired) a new session will be created and saved in the cookie.
...
<p>
    A <em>session</em>, as far as F-engine is concerned, is simply an array containing the following information:
</p>
<ul>
    <li>
...
<p>
    ...
    is the array index corresponding to the item you wish to fetch.  For example, to fetch the session ID you
    will do this:
</p>
<code>
...
<p>
    ...
    is an associative array containing your new data.  Here's an example:
</p>
<p>
    <code>
        $newdata = array(
...
<p class="important">
    <strong>Note:</strong>
    Cookies can only hold 4KB of data, so be careful not to exceed the capacity.  The
...
<h2>Flashdata</h2>
<p>
    F-engine supports &quot;flashdata&quot;, or session data that will only be available for the next server request, and are then automatically cleared. These can be very useful, and are typically used for informational or status messages (for example: &quot;record 2 deleted&quot;).
</p>
<p>
...
<p>
    <strong>Note:</strong>
    By default the table is called 
    <dfn>
        ci_sessions
    </dfn>, but you can name it anything you want 
    as long as you update the 
    <kbd>
        application/config/config.php
    </kbd>
    file so that it contains the name you have chosen.
...
<p class="important">
    <strong>Note:</strong>
    The Session class has built-in garbage collection which clears out expired sessions so you
...
<p class="important">
    <strong>Note:</strong>
    This function should be the last one called, and even flash variables will no longer be available.  If you only want some items destroyed and not all, use 
    <dfn>
        unset_userdata()
    </dfn>.
</p>
...
<table cellpadding="0" cellspacing="1" border="0" style="width:100%" class="tableborder">
    ...
    <tr>
        <td class="td">
            <strong>sess_cookie_name</strong>
        </td>
        <td class="td">
            ci_session
        </td>
    ...
    <tr>
        <td class="td">
            <strong>sess_encrypt_cookie</strong>
        </td>
        <td class="td">
            FALSE
        </td>
    ...
    <tr>
        <td class="td">
            <strong>sess_use_database</strong>
        </td>
        <td class="td">
            FALSE
        </td>
        ...
        <td class="td">
            Whether to save the session data to a database.  You must create the table before enabling this option.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>sess_table_name</strong>
        </td>
        <td class="td">
            ci_sessions
        </td>
    ...
    <tr>
        <td class="td">
            <strong>sess_time_to_update</strong>
        </td>
        <td class="td">
            300
        </td>
    ...
    <tr>
        ...
        <td class="td">
            Whether to match the user's IP address when reading the session data.  Note that some ISPs dynamically
            changes the IP, so if you want a non-expiring session you will likely set this to FALSE.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>sess_match_useragent</strong>
        </td>
        <td class="td">
            TRUE
        </td>
