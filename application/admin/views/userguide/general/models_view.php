<h1>Models</h1>
<p>
    Models are <strong>optionally</strong>
    available for those who want to use a more traditional MVC approach.
</p>
<ul>
    <li>
        <a href="#what">What is a Model?</a>
    </li>
    <li>
        <a href="#anatomy">Anatomy of a Model</a>
    </li>
    <li>
        <a href="#loading">Loading a Model</a>
    </li>
    <li>
        <a href="#auto_load_model">Auto-Loading a Model</a>
    </li>
    <li>
        <a href="#conn">Connecting to your Database</a>
    </li>
</ul>
...
<p>
    ...
    you use F-engine to manage a blog.  You might have a model class that contains functions to insert, update, and
...
<code>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;{
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$query = $this->db->get('*','entries', array('limit'=>10));
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return $query->result();
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;}
    ...
    <br/>
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$this->db->update('entries',&nbsp;$this, array('where'=>array('id' => $_POST['id'])));
    <br/>
    &nbsp;&nbsp;&nbsp;&nbsp;}
    <br/>
    <br/>
...
<p>
    ...
    folder.  They can be nested within sub-folders if you
...
<p>
    ...
    is the name of your class.  Class names <strong>must</strong>
    have the first letter capitalized with the rest of the name lowercase.
...
<p>
    If you model is located in a sub-folder, include the relative path from your models folder.  For example, if 
    you have a model located at 
    <dfn>
...
<p>
    If you find that you need a particular model globally throughout your  application, you can tell F-engine to auto-load it during system  initialization.  This is done by opening the application/config/autoload.php file and adding the model to the autoload array.
</p>
<h2><a name="conn"></a>Connecting to your Database</h2>
<p>
    When a model is loaded it does <strong>NOT</strong>
    connect automatically to your database.  The following options for connecting are available to you:
</p>
<ul>
    <li>
    ...
    <li>
        ...
        (boolean) via the third parameter,
