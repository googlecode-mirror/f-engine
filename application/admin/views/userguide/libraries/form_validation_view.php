...
<ul>
    ...
    <li>
        <a href="#tutorial">Form Validation Tutorial</a>
        <ul>
            <li>
                <a href="#theform">The Form</a>
            </li>
            <li>
                <a href="#thesuccesspage">The Success Page</a>
            </li>
            <li>
                <a href="#thecontroller">The Controller</a>
            </li>
            <li>
                <a href="#validationrules">Setting Validation Rules</a>
            </li>
            <li>
                <a href="#validationrulesasarray">Setting Validation Rules Using an Array</a>
            </li>
            <li>
                <a href="#cascadingrules">Cascading Rules</a>
            </li>
            <li>
                <a href="#preppingdata">Prepping Data</a>
            </li>
            <li>
                <a href="#repopulatingform">Re-populating the Form</a>
            </li>
            <li>
                <a href="#callbacks">Callbacks</a>
            </li>
            <li>
                <a href="#settingerrors">Setting Error Messages</a>
            </li>
            <li>
                <a href="#errordelimiters">Changing the Error Delimiters</a>
            </li>
            <li>
                <a href="#translatingfn">Translating Field Names</a>
            </li>
            <li>
                <a href="#individualerrors">Showing Errors Individually</a>
            </li>
            <li>
                <a href="#savingtoconfig">Saving Sets of Validation Rules to a Config File</a>
            </li>
            <li>
                <a href="#arraysasfields">Using Arrays as Field Names</a>
            </li>
        </ul>
    </li>
    <li>
        <a href="#rulereference">Rule Reference</a>
    </li>
    <li>
        <a href="#preppingreference">Prepping Reference</a>
    </li>
    <li>
        <a href="#functionreference">Function Reference</a>
    </li>
    <li>
        <a href="#helperreference">Helper Reference</a>
    </li>
</ul>
<p>
    &nbsp;
...
<p>
    Although there is nothing terribly complex about the above process, it usually requires a significant
...
<p>
    What follows is a "hands on" tutorial for implementing F-engines Form Validation.
</p>
<p>
...
<p>
    <strong>Since you haven't told the Form Validation class to validate anything yet, it returns 
        <kbd>
            FALSE
        </kbd>
        ...
        if it has successfully applied your rules without any of them failing.
    </strong>
</p>
<h2>Explanation</h2>
<p>
...
<p>
    ...
    at the same time. To set validation rules you will use the 
    <dfn>
        set_rules()
    </dfn>
    function:
...
<p>
    The above function takes <strong>three</strong>
    parameters as input:
</p>
<ol>
    <li>
    ...
    <li>
        A "human" name for this field, which will be inserted into the error message. For example, if your field is named "user" you might give it a human name of "Username". <strong>Note:</strong>
        If you would like the field name to be stored in a language file, please see <a href="#translatingfn">Translating Field Names</a>.
    </li>
    <li>
...
<p>
    <dfn>
        Now submit the form with the fields blank and you should see the error messages.
...
<p>
    Before moving on it should be noted that the rule setting function can be passed an array if you prefer to set all your rules in one action.
...
<p>
    F-engine lets you pipe multiple rules together.  Let's try it. Change your rules in the third parameter of rule setting function, like this:
</p>
<code>
...
<p>
    Give it a try! Submit your form without the proper data and you'll see new error messages that correspond to your new rules.
...
<p>
    Thus far we have only been dealing with errors.  It's time to repopulate the form field with the submitted data. F-engine offers several helper functions
...
<p>
    ...
    view file and update the <strong>value</strong>
    in each field using the 
    <dfn>
        set_value()
    </dfn>
    function:
...
<p>
    <strong>Don't forget to include each. field name in the 
        <dfn>
            set_value()
        </dfn>
        functions!
...
<p class="important">
    <strong>Note:</strong>
    The <a href="#functionreference">Function Reference</a>
    section below contains functions that
...
<code>
    ...
    <kbd>
        colors[]
    </kbd>" value="&lt;?php echo set_value('
    <kbd>
        colors[]
    </kbd>'); ?>" size="50" />
</code>
<p>
    For more info please see the <a href="#arraysasfields">Using Arrays as Field Names</a>
    section below.
</p>
<a name="callbacks"></a>
...
<p>
    ...
    in your error string, it will be replaced with the "human" name you used for your field when you set your rules.
</p>
<p>
...
<p>
    ...
    function in a language file, and therefore make the name able to be translated, here's how:
</p>
<p>
    First, prefix your "human" name with 
    <dfn>
        lang:
    </dfn>, as in this example:
</p>
<code>
    $this->form_validation->set_rules('first_name', '
    <kbd>
        lang:
    </kbd>first_name', 'required');
    <br/>
</code>
<p>
...
<ol>
    <li>
        <strong>Changing delimiters Globally</strong>
        <p>
    ...
    <li>
        <strong>Changing delimiters Individually</strong>
        <p>
...
<p>
    ...
    folder. 
    In that file you will place an array named 
    <kbd>
        $config
    </kbd>
    with your rules. As shown earlier, the validation array will have this prototype:
</p>
<code>
    $config = array(
    <br/>
...
<p>
    ...
    <kbd>
        signup
    </kbd>.  Here's what your class might look like:
</p>
<code>
    &lt;?php
    <br/>
...
<p>
    If you do use an array as a field name, you must use the EXACT array name in the <a href="#helperreference">Helper Functions</a>
    that require the field name,
    and as your Validation Rule field name.
</p>
<p>
...
<p>
    If you are using checkboxes (or other fields) that have multiple options, don't forget to leave an empty bracket after each option, so that all selections will be added to the
    POST array:
</p>
<code>
...
<ul>
    ...
    <li>
        <a href="#savingtoconfig">Saving Groups of Validation Rules to a Config File</a>
    </li>
</ul>
...
<p>
    ...
    group via the function, as described in: <a href="#savingtoconfig">Saving Groups of Validation Rules to a Config File</a>.
</p>
<h2>$this->form_validation->set_message();</h2>
<p>
    Permits you to set custom error messages.  See <a href="#settingerrors">Setting Error Messages</a>
    above.
</p>
<p>
    &nbsp;
...
<p>
    The following helper functions are available for use in the view files containing your forms.  Note that these are procedural functions, so they<strong>do not</strong>
    require you to prepend them with $this->form_validation.
</p>
<h2>form_error()</h2>
<p>
...
<p>
    The error delimiters can be optionally specified.  See the <a href="#errordelimiters">Changing the Error Delimiters</a>
    section above.
</p>
...
<p>
    ...
    menu, this function permits you to display the menu item that was selected.  The first parameter
...
<code>
    ...
    &lt;option value="two" 
    <dfn>
        &lt;?php echo  set_select('myselect', 'two'); ?>
    </dfn>
    >Two&lt;/option>
    <br/>
    &lt;option value="three" 
    <dfn>
        &lt;?php echo  set_select('myselect', 'three'); ?>
    </dfn>
    >Three&lt;/option>
    <br/>
    &lt;/select>
...
<code>
    ...
    <dfn>
        &lt;?php echo set_checkbox('mycheck[]', '1'); ?>
    </dfn>
    />
    <br/>
...
<h2>set_radio()</h2>
<p>
    Permits you to display radio buttons in the state they were submitted. This function is identical to the <strong>set_checkbox()</strong>
    function above.
</p>
<code>
