...
<p>
    F-engine's Image Manipulation class lets you perform the following actions:
</p>
<ul>
    <li>
        Image Resizing
...
<p>
    Like most other classes in F-engine, the image class is initialized in your controller 
    using the 
    <dfn>
        $this->load-&gt;library
    </dfn>
...
<p>
    ...
    function to look for an image called <em>mypic.jpg</em>
    located in the 
    <dfn>
        source_image
    </dfn>
    folder, then create a thumbnail that is 75 X 50 pixels using the GD2 
    <dfn>
        image_library
    </dfn>. 
    Since the 
    ...
    option is enabled, the thumb will be as close to the target 
    <dfn>
        width
    </dfn>
    and
    ...
    as possible while preserving the original aspect ratio.  The thumbnail will be called <em>mypic_thumb.jpg</em>
</p>
<p class="important">
    <strong>Note:</strong>
...
<table cellpadding="0" cellspacing="1" border="0" style="width:100%" class="tableborder">
    ...
    <tr>
        ...
        <td class="td">
            Sets the Y coordinate in pixels for image cropping. For example, a setting of 30 will crop an image 30 pixels from the top.
        </td>
        <td class="td">
            C
        </td>
...
<p>
    The resizing function will create a copy of the image file (and preserve the original) if you set
    a path and/or a new filename using this preference:
</p>
<code>
...
<p>
    If neither of the two preferences listed above (create_thumb, and new_image) are used, the resizing function will instead
...
<ul>
    <li>
        <strong>Text</strong>: The watermark message will be generating using text, either with a True Type font that you specify, or
    ...
    <li>
        <strong>Overlay</strong>: The watermark message will be generated by overlaying an image (usually a transparent PNG or GIF)
        containing your watermark over the source image.
    </li>
</ul>
<h2>Watermarking an Image</h2>
<p>
    Just as with the other functions (resizing, cropping, and rotating) the general process for watermarking
...
<table cellpadding="0" cellspacing="1" border="0" style="width:100%" class="tableborder">
    ...
    <tr>
        ...
        <td class="td">
            The amount of padding, set in pixels, that will be applied to the watermark to set it away from the edge of your images.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_vrt_alignment</strong>
        </td>
        <td class="td">
            bottom
        </td>
    ...
    <tr>
        <td class="td">
            <strong>wm_hor_alignment</strong>
        </td>
        <td class="td">
            center
        </td>
    ...
    <tr>
        ...
        <td class="td">
            You may specify a horizontal offset (in pixels) to apply to the watermark position. The offset normally moves the watermark to the right, except if you have your alignment set to "right" then your offset value will move the watermark toward the left of the image.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_vrt_offset</strong>
        </td>
        <td class="td">
            None
        </td>
        ...
        <td class="td">
            You may specify a vertical offset (in pixels) to apply to the watermark position. The offset normally moves the watermark down, except if you have your alignment set to "bottom" then your offset value will move the watermark toward the top of the image.
        </td>
    </tr>
</table>
...
<table cellpadding="0" cellspacing="1" border="0" style="width:100%" class="tableborder">
    ...
    <tr>
        ...
        <td class="td">
            The text you would like shown as the watermark.  Typically this will be a copyright notice.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_font_path</strong>
        </td>
        <td class="td">
            None
        </td>
        ...
        <td class="td">
            The server path to the True Type Font you would like to use.  If you do not use this option, the native GD font will be used.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_font_size</strong>
        </td>
        <td class="td">
            16
        </td>
        ...
        <td class="td">
            The size of the text.  Note: If you are not using the True Type option above, the number is set using a range of 1 - 5.  Otherwise, you can use any valid pixel size for the font you're using.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_font_color</strong>
        </td>
        <td class="td">
            ffffff
        </td>
        ...
        <td class="td">
            The font color, specified in hex.  Note, you must use the full 6 character hex value (ie, 993300), rather than the three character abbreviated version (ie fff).
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_shadow_color</strong>
        </td>
        <td class="td">
            None
        </td>
        ...
        <td class="td">
            The color of the drop shadow, specified in hex. If you leave this blank a drop shadow will not be used. Note, you must use the full 6 character hex value (ie, 993300), rather than the three character abbreviated version (ie fff).
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_shadow_distance</strong>
        </td>
        <td class="td">
            3
        </td>
...
<table cellpadding="0" cellspacing="1" border="0" style="width:100%" class="tableborder">
    ...
    <tr>
        ...
        <td class="td">
            The server path to the image you wish to use as your watermark. Required only if you are using the overlay method.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_opacity</strong>
        </td>
        <td class="td">
            50
        </td>
        ...
        <td class="td">
            Image opacity. You may specify the opacity (i.e. transparency) of your watermark image. This allows the watermark to be faint and not completely obscure the details from the original image behind it. A 50% opacity is typical.
        </td>
    </tr>
    <tr>
        <td class="td">
            <strong>wm_x_transp</strong>
        </td>
        <td class="td">
            4
        </td>
    ...
    <tr>
        ...
        <td class="td">
            Along with the previous setting, this allows you to specify the coordinate to a pixel representative of the color you want to be transparent.
        </td>
    </tr>
</table>
