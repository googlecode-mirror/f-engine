...
<p>
    ...
    file.  In it you'll see an array called 
    <dfn>
        $route
    </dfn>
    that 
    permits you to specify your own routing criteria. Routes can either be specified using 
    <dfn>
        wildcards
    </dfn>
    or 
...
<p>
    A URL containing the segments blog/joe will be remapped to the "blogs" path|filename and the "users" path|filename|param.  The ID will be set to "34".
</p>
<code>
    $route['product/:any'] = "catalog/product_lookup";
</code>
<p>
    A URL with "product" as the first segment, and anything in the second will be remapped to the "catalog/product_lookup".
</p>
<code>
    $route['product/(:num)'] = "catalog/product_lookup_by_id/$1";
</code>
<p>
    A URL with "product" as the first segment, and anything in the second will be remapped to the "catalog/product_lookup_by_id" passing in the match as a variable to the function.
</p>
<p class="important">
...
<p class="important">
    <strong>Note:</strong>&nbsp; If you use back-references you must use the dollar syntax rather than the double backslash syntax.
</p>
<p>
...
<p>
    In the above example, a URI similar to 
    <dfn>
        products/shirts/123
    </dfn>
...
<p>
    This route indicates which controller class should be loaded if the URI contains no data, which will be the case
...
<p class="important">
    <strong>Important:</strong>&nbsp; The reserved routes must come before any wildcard or regular expression routes.
</p>
