...
<p>
    If you are not familiar with Trackbacks you'll find more information <a href="http://en.wikipedia.org/wiki/Trackback">here</a>.
</p>
<h2>Initializing the Class</h2>
<p>
    Like most other classes in F-engine, the Trackback class is initialized in your controller using the 
    <dfn>
        $this->load->library
    </dfn>
    function:
...
<ul>
    <li>
        <strong>ping_url</strong>
        - The URL of the site you are sending the Trackback to. You can send Trackbacks to multiple URLs by separating each URL with a comma.
    </li>
    <li>
        <strong>url</strong>
        - The URL to YOUR site where the weblog entry can be seen.
    </li>
    <li>
        <strong>title</strong>
        - The title of your weblog entry.
    </li>
    <li>
        <strong>excerpt</strong>
        - The content of your weblog entry. Note: the Trackback class will automatically send only the first 500 characters of your entry.  It will also strip all HTML.
    </li>
    <li>
    ...
    <li>
        ...
        - The character encoding your weblog is written in.  If omitted, UTF-8 will be used.
    </li>
</ul>
<p>
...
<p>
    For example, if your controller class is called 
    <dfn>
        Trackback
...
<code>
    http://example.com/index.php/trackback/receive/
    <samp>
        entry_id
    </samp>
</code>
<p>
    ...
    represents the individual ID number for each of your entries.
</p>
...
<p>
    The Trackback specification only requires four pieces of information to be sent in a Trackback (url, title, excerpt, blog_name),
    but to make the data more useful we've added a few more fields in the above table schema (date, IP address, etc.).
</p>
...
<p>
    ...
    function is simply a validation function that looks at the incoming data
...
<p>
    ...
    represents one of these four pieces of info: url, title, excerpt, or blog_name
</p>
<p>
