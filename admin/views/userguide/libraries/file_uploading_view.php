...
<p>F-engine's File Uploading Class permits files to be uploaded.  You can set various
...
<p>You'll need a destination folder for your uploaded images.  Create a folder at the root of your F-engine installation called
...
<p>Like most other classes in F-engine, the Upload class is initialized in your controller using the <dfn>$this->load->library</dfn> function:</p>
