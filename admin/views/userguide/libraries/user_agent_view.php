...
<p>
    ...
    In addition you can get referrer information as well as language and supported character-set information.
</p>
<h2>Initializing the Class</h2>
<p>
    Like most other classes in F-engine, the User Agent class is initialized in your controller using the 
    <dfn>
        $this->load->library
    </dfn>
    function:
...
<p>
    Once loaded, the object will be available using: 
    <dfn>
        $this->agent
    </dfn>
</p>
...
<p>
    ...
    </dfn>.  You may add items to the
    various user agent arrays if needed.
</p>
<h2>Example</h2>
<p>
...
<p class="important">
    <strong>Note:</strong>&nbsp; The user agent library only contains the most common robot
...
<p class="important">
    <strong>Note:</strong>
    This function is not typically very reliable 
