...
<h2>form_open()</h2>
<p>
    Creates an opening form tag with a base URL <strong>built from your config preferences</strong>.  It will optionally let you
    add form attributes and hidden input fields.
</p>
<p>
...
<p>
    ...
    tag above except that it adds a multipart attribute,
...
<p>
    ...
    value you wish to be selected.  You can also pass an array through the third parameter, and F-engine will create a multiple select for you. Example:
</p>
<code>
    $options = array(
    <br/>
...
<p>
    ...
    The form_prep function converts HTML so that it can be used safely:
</p>
<code>
    &lt;input type="text" name="myform" value="
    <var>
        &lt;?php echo form_prep($string); ?>
    </var>" />
</code>
<p class="important">
    <strong>Note:</strong>
    If you use any of the form helper functions listed in this page the form
